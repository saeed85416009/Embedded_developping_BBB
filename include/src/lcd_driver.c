...
{
    gpio_write_value_lcd(GPIO_69_P8_9_EN_6,LCD_ENABLE);
    usleep(2 * 1000); //2ms delay
    gpio_write_value_lcd(GPIO_69_P8_9_EN_6,LCD_DISABLE);
...
void lcd_print_char(uint8_t ascii_Value)
{
    ...
    gpio_write_value_lcd(GPIO_66_P8_7_RS_4,USER_DATA_MODE);

    //first send the msb

    uint8_t data_msb = ((ascii_Value >> 4) & 0X0f ); // d7 d7 d5 d4

    gpio_write_value_lcd(LCD_DATABIT4,(data_msb & ( 1 << 0) ));
    gpio_write_value_lcd(LCD_DATABIT5,(data_msb & ( 1 << 1) ));
    gpio_write_value_lcd(LCD_DATABIT6,(data_msb & ( 1 << 2) ));
    gpio_write_value_lcd(LCD_DATABIT7,(data_msb & ( 1 << 3) ));
    ...
    gpio_write_value_lcd(LCD_DATABIT4,(data_lsb & ( 1 << 0) ));
    gpio_write_value_lcd(LCD_DATABIT5,(data_lsb & ( 1 << 1) ));
    gpio_write_value_lcd(LCD_DATABIT6,(data_lsb & ( 1 << 2) ));
    gpio_write_value_lcd(LCD_DATABIT7,(data_lsb & ( 1 << 3) ));
...
the LCD like setting font, cursor position etc. */
    ...
    //first make RS=0
    gpio_write_value_lcd(GPIO_66_P8_7_RS_4,COMMAND_MODE);

    //first send the msb

    uint8_t command_msb = ((command >> 4) & 0X0f ); // d7 d6 d5 d4

    gpio_write_value_lcd(LCD_DATABIT4,(command_msb & ( 1 << 0) ));
    gpio_write_value_lcd(LCD_DATABIT5,(command_msb & ( 1 << 1) ));
    gpio_write_value_lcd(LCD_DATABIT6,(command_msb & ( 1 << 2) ));
    gpio_write_value_lcd(LCD_DATABIT7,(command_msb & ( 1 << 3) ));
    ...
    gpio_write_value_lcd(LCD_DATABIT4,(command_lsb & ( 1 << 0) ));
    gpio_write_value_lcd(LCD_DATABIT5,(command_lsb & ( 1 << 1) ));
    gpio_write_value_lcd(LCD_DATABIT6,(command_lsb & ( 1 << 2) ));
    gpio_write_value_lcd(LCD_DATABIT7,(command_lsb & ( 1 << 3) ));
